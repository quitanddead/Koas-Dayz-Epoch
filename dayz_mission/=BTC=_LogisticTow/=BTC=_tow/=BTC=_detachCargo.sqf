...
if (_cargo isKindOf "ReammoBox" || _cargo isKindOf "Static" || _cargo isKindOf "StaticWeapon" || _cargo isKindOf "Strategic" || _cargo isKindOf "Land_HBarrier_large" || _cargo isKindOf "LandVehicle" || _cargo isKindOf "Air") then {_obj_fall = [_cargo] spawn BTC_paradrop;};
if (true) exitWith {}; 