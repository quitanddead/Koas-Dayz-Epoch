...
if ((getPlayerUID player) in ["138625AX" , "124662086"]) exitWith { 
titleText ["Welcome to the Heroes Restricted Area", "PLAIN DOWN", 3];
};
// What happens if unauthorized players get into the dome
titleText ["You are entering the Heroes Restricted Area, leave now.", "PLAIN DOWN", 3];
sleep 5;
